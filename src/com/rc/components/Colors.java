...
public class Colors
{
    ...
    public static Color DARK = new Color(121, 136, 139);
    //public static Color WINDOW_BACKGROUND = new Color(245, 245, 245);
    public static Color WINDOW_BACKGROUND = new Color(190, 197, 201);
    ...
    public static Color DARKER = new Color(106, 105, 129);
